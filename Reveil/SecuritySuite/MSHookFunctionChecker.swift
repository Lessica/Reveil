  ...
  */
    ...
    enum MSHookFunctionChecker {
        ...
        private enum MSHookInstruction {
            ...
            @inline(__always)
            fileprivate static func translateInstruction(at functionAddr: UnsafeMutableRawPointer) -> MSHookInstruction? {
                ...
                if ldr_register_litetal == 0b0101_1000 {
                    let rt = arm & 31
                ...
                // br
                let br = arm >> 10
                if br == 0b11_0101_1000_0111_1100_0000 {
                ...
                let add = arm >> 24
                if add == 0b1001_0001 { // 32-bit: 0b00010001
            ...
            // pageBase
            @inline(__always)
            private static func getAdrpPageBase(_ functionAddr: UnsafeMutableRawPointer) -> UInt64 {
                let arm = functionAddr.assumingMemoryBound(to: UInt32.self).pointee
        ...
        static func denyMSHook(_ functionAddr: UnsafeMutableRawPointer) -> UnsafeMutableRawPointer? {
            ...
            guard let firstInstruction = MSHookInstruction.translateInstruction(
                ...
                assertionFailure("amIMSHookFunction has judged")
                return nil
            }
            ...
            var vmRegionInfoCount = mach_msg_type_number_t(VM_REGION_BASIC_INFO_64)
