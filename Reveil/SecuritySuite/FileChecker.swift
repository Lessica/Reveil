...
enum FileChecker {
     ...
     */
    struct MountedVolumeInfo: Codable {
     ...
     */
    static func getMountedVolumeInfoViaStatfs(path: String, encoding: String.Encoding = .utf8) -> MountedVolumeInfo? {
